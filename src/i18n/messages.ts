const ar = {
  ...
  results: {
    ...
    submitNote:
      "بعد التسليم لا يمكن تغيير الإجابات. الأسئلة غير المُجاب عنها تُحسب صفرًا.",
    submit: "تسليم الاختبار",
    title: "النتيجة",
    submitted: "تم تسليم الاختبار.",
    expired: "انتهى الوقت، وصُحّح الاختبار بالإجابات المحفوظة قبل الموعد.",
    score: "العلامة",
    scoreValue: (score: string, max: string) => `${score} من ${max}`,
    correct: "إجابات صحيحة",
    incorrect: "إجابات خاطئة",
    unanswered: "بلا إجابة",
    heading: "نتائج الطلاب",
    student: "الطالب",
    className: "الصف",
    status: "الحالة",
    statuses: {
    ...
    assigned: "الطلاب المعنيون",
    finished: "أنهوا الاختبار",
    inProgress: "قيد الحل",
    notStarted: "لم يبدؤوا",
    average: "متوسط النتيجة",
    quizzesTitle: "الاختبارات المنشورة",
    quiz: "الاختبار",
    teacher: "المعلّم",
    classes: "الصفوف",
    view: "عرض النتائج",
...
const en: Dictionary = {
  ...
  results: {
    submitTitle: "Submit the quiz",
    submitNote:
      "After submitting, answers cannot change. Unanswered questions score zero.",
    submit: "Submit quiz",
    title: "Result",
    submitted: "The quiz was submitted.",
    expired:
      "Time ran out; the quiz was graded from answers saved before the deadline.",
    score: "Score",
    scoreValue: (score: string, max: string) => `${score} of ${max}`,
    correct: "Correct",
    incorrect: "Incorrect",
    ...
    quizzesTitle: "Published quizzes",
    quiz: "Quiz",
    teacher: "Teacher",
    classes: "Classes",
    view: "View results",
